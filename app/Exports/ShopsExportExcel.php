...
class ShopsExportExcel implements FromArray, WithEvents, ShouldAutoSize
{
    public $data;
    public $summary;
    ...
    public function array(): array
    {
        ...
        $headers = ['ID','Name','Phone','Powerfull ID','Provider ID','SIM','Device ID','Address','Created At'];
        $userRows = $this->data->map(function ($shop) {
            // prepare shop logo             
            return [
            $shop->id,
            $shop->name, 
